...
export const breakdownTask = async (
    ...
    Return a JSON object conforming exactly to this structure:
    {
      "subtasks": [
        { 
          "title": "Subtask Name", 
          "estimatedHours": 2,
          "priority": "Medium", // must be Low, Medium, High, or Critical
          "description": "Short explanation of this subtask",
          "tags": ["frontend", "auth"],
          "acceptanceCriteria": ["User can login", "Token stored securely"]
        }
      ],
  ...
  try {
    ...
    return {
      subtasks: [
        { title: `Setup boilerplate logic for: ${title}`, estimatedHours: 2, priority: 'High', description: 'Initial setup generated by fallback', tags: ['setup'] },
        { title: 'Write core implementation scripts', estimatedHours: 3, priority: 'Medium', description: 'Core implementation', tags: ['backend', 'core'] },
        { title: 'Create unit testing validations', estimatedHours: 2, priority: 'Low', description: 'Write unit tests', tags: ['testing'] },
      ],
      estimatedOrder: [
